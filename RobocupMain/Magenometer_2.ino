...
//        
////        Serial.print(" qangle = "); Serial.println(atan2(q[2], q[1])  * (180.0 / M_PI)); //* 180.0 / M_PI; (degrees + 360) % 360
//        Serial.print(" mangle = "); Serial.println((atan2(my, mx) * (180.0 / M_PI)) + 180); //* 180.0 / M_PI;
//      }
//
